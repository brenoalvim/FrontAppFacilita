...
export default function UserIndex() {
    ...
    function renderUserTable(data: any) {
      ...
      for (let i = 0; i < data.length; i++) {
        ...
        <tr>
          ...
          <td>${data[i].status}</td>
        <td>
          <a href="Alterar/Loan/${data[i].id}" target="_blank">
            <img src='icon/pen-to-square-solid.svg'/>
          </a>
        </td>
        <td>
          <a href="Remover/Loan/${data[i].id}" target="_blank">
  ...
  return (
    <UserContainer>
      <Meta></Meta>
      <Link />
      <Title name="Empréstimo" />
      <Header title="CRUD Empréstimos" />
      {/* <h2>CRUD usuários</h2> */}
      ...
      <a href="Adicionar/Loan" target={`_blank`}>
